      ...
      <div className="flex flex-col space-y-4 md:flex-row md:gap-20 2xl:gap-0 justify-between bg-black-600 py-14 px-8 md:px-20 xl:px-40 2xl:px-64">
        ...
        <div className="md:w-2/3">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15893.17864281056!2d119.49994361147148!3d-5.216319555465319!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dbee267ff62d2b7%3A0xa96ffb26e4edcc26!2sUniversitas%20Islam%20Negeri%20Alauddin%20Makassar!5e0!3m2!1sid!2sus!4v1744475555376!5m2!1sid!2sus"
            style={{ border: 0 }}
            allowFullScreen
            loading="lazy"
