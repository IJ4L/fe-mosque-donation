  ...
  return (
    <section
      className="
        ...
        justify-between items-center space-y-4 md:space-y-0 md:space-x-4
      "
    >
      <div
        className="
          flex flex-col justify-center items-center space-y-2 w-full 
          py-5 md:py-10 border-2 border-gray-200/30 rounded-xl
        "
      >
      ...
      <div
        className="
          flex flex-col justify-center items-center space-y-2 w-full 
          py-5 md:py-10 bg-primary-700 rounded-xl
        "
      >
